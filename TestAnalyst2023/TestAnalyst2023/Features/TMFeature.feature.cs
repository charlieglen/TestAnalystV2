...
namespace TestAnalyst2023.Features
{
...
#line hidden
#line 17
 testRunner.And(string.Format("I update \'{0}\', \'{1}\', \'{2}\' on an existing time and material record", description, code, prices), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 18
 testRunner.Then(string.Format("The record should have the updated \'{0}\', \'{1}\', \'{2}\'", description, code, prices), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
#line 30
 testRunner.And("I deleted the last time and material record created", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 31
